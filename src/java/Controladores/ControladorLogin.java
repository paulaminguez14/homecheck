...
public class ControladorLogin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (email == null || password == null || email.isEmpty() || password.isEmpty()) {
            ...
            if (usu != null) {
                if (!usu.isActivo()) {
                    error = "Su cuenta está desactivada temporalmente. Por favor, póngase en contacto con soporte.";
                } else {
                    ...
                    if (usu.getRol().equals("USUARIO")) {
                        ...
                        response.sendRedirect(request.getContextPath() + "/Controladores.Admin/ControladorInicioAdmin");
                    }
                    return;
                }
            } else {
