...
<%@page import="Modelo.Entidades.Provincias"%>
    ...
    <body>
        <header>
            ...
            <nav class='menuCabecera' id="menu">
                <ul style="list-style: none; margin: 0; padding: 10px; display: flex; flex-direction: column; gap: 10px;">
                    <li>
                        <a href="ControladorBuscarExperiencias">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-home">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <path d="M5 12l-2 0l9 -9l9 9l-2 0" />
                            <path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" />
                            <path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" />
                            </svg> Explorar viviendas
                        </a>
                    </li>
                    <li>
                        <a href="ControladorPublicarVivienda">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-speakerphone">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <path d="M18 8a3 3 0 0 1 0 6" />
                            <path d="M10 8v11a1 1 0 0 1 -1 1h-1a1 1 0 0 1 -1 -1v-5" />
                            <path d="M12 8h0l4.524 -3.77a.9 .9 0 0 1 1.476 .692v12.156a.9 .9 0 0 1 -1.476 .692l-4.524 -3.77h-8a1 1 0 0 1 -1 -1v-4a1 1 0 0 1 1 -1h8" />
                            </svg> Publicar propiedad
                        </a>
                    </li>
                    <li>
                        <a href="ControladorComoFunciona">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-question-mark">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    ...
                    <li>
                        <a href="ControladorUsuarios?editar=true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black" class="icon icon-tabler icons-tabler-filled icon-tabler-user">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        <main class="mainPublicarVivienda">
            <div class="contenedorPublicarVivienda">
                ...
                <form id="formPublicarVivienda" action="ControladorPublicarVivienda" method="post" class="formularioPublicarVivienda" enctype="multipart/form-data">
                    ...
                    <div class="datosRegistro">
                        ...
                        <select name="provincia" id="provincia"  onchange="cargarCiudades()" class="custom-select-publicar">
                    ...
                    <div class="datosRegistro">
                        ...
                        <select name="ciudad" id="ciudad" class="custom-select-publicar">
                    ...
                    <div class="datosRegistro">
                        ...
                        <input type="text" id="codigoPostal" name="codigoPostal" pattern="\d{5}" title="Introduce un código postal válido de 5 dígitos">
                    </div>
                    <div class="datosRegistro">
                    ...
                    <button type="submit" id="buscar" style="background-color: #2C2C2C; color: white;">Publicar Vivienda</button>
                </form>
        ...
        <script>
            document.getElementById("formPublicarVivienda").addEventListener("submit", function (e) {
                ...
                if (!direccion || !precio || !provincia || !ciudad || !codigoPostal || !habitaciones || !banos || !descripcion || fotos.length === 0) {
                    Swal.fire({
                        icon: 'warning',
                        title: '¡Error!',
                    ...
                    Swal.fire({
                        ...
                        text: 'Introduce un código postal válido de 5 dígitos.',
        ...
        <script>
            document.getElementById("buscar").addEventListener("click", function () {
                console.log("Se hizo clic en Publicar");
            });
        </script>
        <script>
            function cargarCiudades() {
                ...
                fetch('${pageContext.request.contextPath}/obtenerCiudades?idProvincia=' + encodeURIComponent(idProvincia))
                        .then(response => {
                            if (!response.ok) {
                        ...
                        .catch(error => {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: '¡Error!',
                                text: 'No se pudieron cargar las ciudades. Intente de nuevo.',
                                confirmButtonColor: '#3085d6',
                                background: '#fff', // Fondo blanco
                                color: '#333', // Color texto
                                customClass: {
