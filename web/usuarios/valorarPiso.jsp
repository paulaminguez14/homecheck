<%-- 
    Document   : valorarPiso
    Created on : 18 may 2025, 17:28:12
    Author     : pauladominguez
--%>

<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>

<%@ page import="Modelo.Entidades.Vivienda" %>
...
<html>
    ...
    <body>
        ...
        <main class="mainValorarPiso">
            <h1>Valorar Piso: <%= vivienda.getDireccion()%></h1>

            <form method="post" action="ControladorValoraciones">
                <input type="hidden" name="tipo" value="piso"/>
                <input type="hidden" name="idPiso" value="${vivienda.id}"/>
                ...
                <textarea name="comentario" rows="5" cols="40" required></textarea>

                <input class="botonInicioSesion" type="submit" value="Enviar valoración" style="background-color: #2C2C2C; color: white;"/>
                <a href="#" onclick="history.back(); setTimeout(() => location.reload(), 100);" class="enlaceValorarPiso" style="color: black;">Volver</a>
