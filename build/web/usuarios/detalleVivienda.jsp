...
<html lang="es-ES">
    ...
    <body>
        ...
        <a href="#" onclick="history.back(); setTimeout(() => location.reload(), 100);" class="enlaceVolverDetalle">Volver</a>
            ...
            <div class="viviendaDetalle">
                ...
                <c:if test="${not empty vivienda}">
                    ...
                    <div class="informacionVivienda">
                        ...
                        <p style="text-align: justify">${vivienda.descripcion}</p>
                        ...
                        <c:forEach var="comentario" items="${comentarios}">
                            <div class="comentario" style="border-bottom: 1px solid #ccc; padding: 10px 0;">
                                <p>
                                    ...
                                    </a> - <small><fmt:formatDate value="${comentario.fecha}" pattern="dd/MM/yyyy" /></small>
                                </p>
                            ...
                            <c:forEach var="comentarioCasero" items="${comentariosCasero}">
                                <div class="comentariosCasero" style="border-bottom: 1px solid #ccc; padding: 10px 0; margin-top: 0px;">
                                    <p>
                                        ...
                                        </a> - <small><fmt:formatDate value="${comentarioCasero.fecha}" pattern="dd/MM/yyyy" /></small>
                                    </p>
