...
<html lang="es-ES">
    ...
    <body>
        ...
        <main class="mainInicioAdmin">
            <h2 style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Portal de Administrador</h2>
            <section class="botonesAdministrador">
                ...
                <div class="fila4">
                    ...
                    <button class="botonAdmin" onclick="location.href = 'ControladorDescargarPlanEmpresa'">Descargar plan de Empresa</button>
                </div>
            </section>
        </main>
