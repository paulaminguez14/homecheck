    ...
    <body>
            ...
            <table border="1">
                ...
                <tbody>
                    <c:forEach var="comentario" items="${requestScope.comentarios}">
                        <tr>
                            <td>${comentario.autor.nombre} ${comentario.autor.apellidos}</td>
                            ...
                            <td><fmt:formatDate value="${comentario.fecha}" pattern="dd/MM/yyyy" /></td>
                            <td style="display: flex; align-items: center; justify-content: center;">
                                <form action="ControladorGestionComentarios" method="get" class="formEliminarComentario">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const formulariosEliminar = document.querySelectorAll('.formEliminarComentario');
